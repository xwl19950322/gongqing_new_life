  ...
  <div class="convenient">
      ...
      <div class="tab_content">
        ...
        <yd-tab active-color="#27A5E8" height="35px" font-size="14px" horizontal-scroll v-model="tab2" :prevent-default="false" :item-click="itemClick">
          <yd-tab-panel style="margin-top:5px;" label="补领车牌">
            <div class="yd_tab01">
              <ul>
                <li>
                ...
                <li>
                  <div class="yd_tab01_zi">
                    <span>原车牌号</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input placeholder="请输入您的原车牌号"/>
                  </div>
                </li>
                <li>
                  <div class="yd_tab01_zi">
                    <span>车种类型</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="car_type" type="text"/>
                  </div>
                </li>
              </ul>
              <!-- 登录按钮 -->
          ...
          <yd-tab-panel style="margin-top:5px;" label="机动车变更登记">
            <Carchange/>
          </yd-tab-panel>
          <yd-tab-panel style="margin-top:5px;" label="机动车驾驶证补领">
            <CarlicenseReplacement/>
          </yd-tab-panel>
          <yd-tab-panel style="margin-top:5px;" label="机动车驾驶证变更">
            <CarlicenseChange/>
          </yd-tab-panel>
          <yd-tab-panel style="margin-top:5px;" label="机动车驾驶证注销">
            <CarlicenseThe/>
          </yd-tab-panel>
        </yd-tab>
      </div>
...
import Carchange from "../../page/security/security_car/Carchange";
import CarlicenseReplacement from "../../page/security/security_car/CarlicenseReplacement";
import CarlicenseChange from "../../page/security/security_car/CarlicenseChange";
import CarlicenseThe from "../../page/security/security_car/CarlicenseThe"
